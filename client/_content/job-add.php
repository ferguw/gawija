    ...
    <div class="col-lg-12 page-content">
        ...
        <form id="regForm" action="" method="POST">
            ...
            <div class="tab">
                ...
                <input type="text" data-range="true" placeholder="Start - End" data-multiple-dates-separator=" - "
                    data-language="en" class="datepicker-here form-control" name="date-proj" />
            ...
            <!-- Tab 3 -->
            <div class="tab">
                <div class="col-4 col-lg-1 offset-8 offset-lg-11"><button type="button" class="material-icons btn btn-b2">add</button></div>
